// =========================================================================
// FINPILOT AI — BENCHMARK EVALUATION SCORECARD
// =========================================================================
...
function renderEvaluationScorecard(evalData) {
  ...
  setTxt("evalTP", evalData.exceptions_detected !== undefined ? evalData.exceptions_detected : 0);
  setTxt("evalTN", (evalData.total_records !== undefined && evalData.exceptions_detected !== undefined) ? (evalData.total_records - evalData.exceptions_detected) : 0);
  ...
  setTxt("evalTotalRecords", `${evalData.total_records !== undefined ? evalData.total_records : 120} Records`);
  setTxt("evalDuration", `${evalData.execution_time_s !== undefined ? evalData.execution_time_s : 0.003}s`);
  setTxt("evalThroughput", `${evalData.throughput_rps ? Math.round(evalData.throughput_rps).toLocaleString() : 'Not measured'} records/sec`);
}
